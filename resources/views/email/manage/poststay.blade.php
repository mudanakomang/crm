                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::select('sendafter',[''=>'Day/s after']+range(1,31,1),$poststay->sendafter-1,['class'=>'form-control ']) }}
                                             </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-lg-4 col-md-4">
                                            <div id="templateSelection">
                                                ...
                                                {{ Form::select('template',[''=>'Select Template']+\App\MailEditor::pluck('name','id')->all(),$poststay->template_id,['id'=>'templateChose','class'=>'form-control','onchange'=>'selectTemplate(this.value)']) }}
                                            </div>
                                        </div>
                                    </div>
