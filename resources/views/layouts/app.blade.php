...
<head>
    ...
    <title>Ramayana CRM | DEMO  </title>
    <!-- Favicon-->
    <link rel="icon" href="../../public/favicon.ico" type="image/x-icon">
    <!-- Google Fonts -->
    <link href="{{ asset('css/google-font.css') }}" rel="stylesheet" type="text/css">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="preloader">
            <div class="spinner-layer pl-blue pl-size-md">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">CRM Hotel RCO</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2017 - 2018 <a href="javascript:void(0);">IT SysDev Ramayana & Co</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
